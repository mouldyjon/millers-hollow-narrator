...
- ✅ Valid manifest.json (generated by vite-plugin-pwa)
- ✅ Service worker (generated automatically)
- ✅ Icons in public/ folder (see TODO_ICONS.md)

**Note:** PWA won't install until you add proper icons (192x192 and 512x512).
...
- Custom domain: £10-15/year (e.g., millershollow.com)
...
1. **Add PWA Icons**
   - See `TODO_ICONS.md`
   - Required for full PWA installation
